...
**Инвариантность относительно сцепления (envariance, Цурек, 2003–2005).** Чисто симметрийный ход. Если система максимально сцеплена с окружением и все амплитуды равны по модулю, то существует преобразование среды, возвращающее полное состояние к исходному, но переставляющее исходы системы. Отсюда Цурек заключает, что равноамплитудные исходы обязаны иметь равные вероятности, а общий случай сводит к равноамплитудному дроблением, — и получает $|\psi|^2$, опираясь, как он подчёркивает, только на симметрии сцепления, без обращения к наблюдателю.
...
Честная итоговая формула, на мой взгляд, такова: **правило Борна — это «почти теорема» по форме и всё ещё постулат по смыслу**. Мы знаем, что вероятность обязана быть квадратом амплитуды; мы не знаем до конца, почему этот квадрат есть вероятность.
